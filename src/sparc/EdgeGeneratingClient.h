...
protected:
	...
	void send_edges(const std::vector<std::string> &kmers);
	void send_edges_seq(const std::vector<std::string> &kmers);
	void send_edges_batch(const std::vector<std::string> &kmers);
